...
export default {
  ...
  'dashboard.no_displays_desc': 'Instale o aplicativo {brandName} na sua TV e pareie com o botão acima.',
  ...
  'settings.setup_step_1': 'Instale o APK do {brandName} na sua TV via sideloading',
  ...
  'settings.import.invalid_file': 'Arquivo inválido. Deve ser JSON ou ZIP de exportação do {brandName}.',
  ...
  'onboarding.step.welcome.title': 'Bem-vindo ao {brandName}!',
