...
export default {
  ...
  'dashboard.no_displays_desc': 'Instala la aplicación de {brandName} en tu TV y vincúlala con el botón de arriba.',
  ...
  'content.upload_progress_count': 'Subiendo {count} archivos...',
  ...
  'content.batch_selected': '{count} seleccionado(s)',
  'content.batch_select_all': 'Seleccionar todo',
  'content.batch_select_none': 'Deseleccionar todo',
  'content.batch_move_placeholder': 'Mover a…',
  'content.batch_delete': 'Eliminar ({count})',
  'content.batch_delete_confirm': 'Haz clic otra vez para eliminar {count}',
  'content.toast.batch_moved': '{count} elemento(s) movido(s)',
  'content.toast.batch_deleted': '{count} elemento(s) eliminado(s)',
  ...
  'content.toast.uploaded_count': '{count} archivos se subieron correctamente',
  ...
  'settings.setup_step_1': 'Instala el APK de {brandName} en tu TV mediante sideloading',
  ...
  'settings.import.invalid_file': 'Archivo no válido. Debe ser un JSON o ZIP de exportación de {brandName}.',
  ...
  'widget.webpage_blocked_note': 'Si esta área está en blanco, el sitio bloquea la inserción y tampoco se mostrará en el dispositivo. Prueba con una página que permita la inserción.',
  'widget.close': 'Cerrar',
  ...
  'onboarding.step.welcome.title': '¡Bienvenido a {brandName}!',
